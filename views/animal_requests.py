...
def get_single_animal(id):
    ...
    if requested_animal == None:
        return None


    location = get_single_location(requested_animal["locationId"])
    customer = get_single_customer(requested_animal["customerId"])
...
def create_animal(animal):
    ...
    if "locationId" not in animal:
        return "locationId is required"
    
    if "Status" not in animal:
        return "Status is required"
    
    if "customerId" not in animal:
